/* ============================================================
   ...
   ============================================================ */
export function startSignalBackground(cv) {
    ...
    function pathY(l, x, t) {
        ...
        const wave = Math.sin(u * Math.PI * 2 * l.waves + l.phase + t * l.speed * 60) * l.amp +
    ...
    function drawTravelers(l, t, dt) {
        for (let i = l.travelers.length - 1; i >= 0; i--) {
            ...
            if (tr.u < -0.08 || tr.u > 1.08) {
                l.travelers.splice(i, 1);
                continue;
            }
            const x = tr.u * W;
            const y = pathY(l, x, t);
